...
@Slf4j
@Transactional
public class DeactivateAuthorAccount implements JavaDelegate {

    private final UserRepository userRepository;

    @Override
    public void execute(DelegateExecution execution) throws Exception {
        log.info(LogMessages.EXECUTE, DeactivateAuthorAccount.class.getName());
        ...
        log.info(LogMessages.FINISHED, DeactivateAuthorAccount.class.getName());
    }
}