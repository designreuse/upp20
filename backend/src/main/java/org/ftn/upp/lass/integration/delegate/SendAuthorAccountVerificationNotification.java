...
@Slf4j
@Transactional
public class SendAuthorAccountVerificationNotification implements JavaDelegate {

    private final NotificationService notificationService;

    @Override
    public void execute(DelegateExecution execution) throws Exception {
        log.info(LogMessages.EXECUTE, SendAuthorAccountVerificationNotification.class.getName());
        ...
        log.info(LogMessages.FINISHED, SendAuthorAccountVerificationNotification.class.getName());
    }
}